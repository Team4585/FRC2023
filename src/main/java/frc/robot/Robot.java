...
public class Robot extends HuskyRobot {
  ...
  private FRC2023TeleopDecisionMaker m_TeleopDecider = new FRC2023TeleopDecisionMaker();
  private FRC2023AutonomousDecisionMaker m_AutoDecider = new FRC2023AutonomousDecisionMaker();

  private FRC2023Chassis m_TheChassis = new FRC2023Chassis();
