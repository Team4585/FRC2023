...
public class Robot extends HuskyRobot {
  ...
  private Claw_testTeleopDecisionMaker m_TeleopDecider = new Claw_testTeleopDecisionMaker();
  private Claw_testAutonomousDecisionMaker m_AutoDecider = new Claw_testAutonomousDecisionMaker();
  ...
  public void robotInit() {
    ...
    m_TeleopDecider.setClawSubSystem(m_Claw);
    m_AutoDecider.setClawSubSystem(m_Claw);
